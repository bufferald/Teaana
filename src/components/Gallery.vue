<template  class="commercial">
  <section>
    ...
    <a name="pageone"></a>
    <div class="container-fluid d-flex justify-content-center align-items-center landing bg-1">
      <div class="row">
        <div class="col-12 page-one">
          <h1 class="display-4">Burger</h1>
        </div>
      </div>
    </div>
    <a name="pagetwo"></a>
    <div class="container-fluid d-flex justify-content-center align-items-center landing bg-2">
      <div class="row">
    ...
    <a name="pagethree"></a>
    <div class="container-fluid d-flex justify-content-center align-items-center landing bg-3">
      <div class="row">
